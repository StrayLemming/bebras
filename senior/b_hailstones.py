...
Task:
Write a program that takes, as input, the starting value of a hailstone sequence.
Your program should then determine how many even numbers and how many odd numbers it contains.
...
# Use Modulo to get the remaining division
while number != 1:
    if number % 2 == 0:
        even_count += 1
        number = number / 2
        ...
        odd_count += 1
        number = (number * 3) + 1
odd_count += 1  # include the last odd number (1)
print(even_count)
print(odd_count)
